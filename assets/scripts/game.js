...
var targets = [
        ...
        {x: 300, y: 120, r: 12},
        {x: 60, y: 200, r: 12}, {x: 140, y: 200, r: 12}, {x: 220, y: 200, r: 12}, {x: 300, y: 200, r: 20}, {
            x: 380,
            y: 200,
            r: 12
        }, {x: 460, y: 200, r: 12}, {x: 540, y: 200, r: 12},
        {x: 300, y: 280, r: 12},
...
function detonateTank() {
    ...
    for (var i = 0; i < smokeParticle.smokeSetSize; i++) {
        ...
        var part = {
            x: tank.x + Math.cos(dir) * dist,
            y: tank.y + Math.sin(dir) * dist,
            r: smokeParticle.r,
            dir: dir,
            speed: (Math.random() * .1) + .1,
            alpha: .4,
            baseColor: smokeParticle.baseColor
        };
...
function serveBullets() {
    ...
    for (var i = bullets.length - 1; i >= 0; i--) {
        ...
        bulCollsn = (!tank.destroyed) ? Collision.circleToPolygon({
            x: bullets[i].x,
            y: bullets[i].y,
            r: bullet.r
        }, skPoly) : null;
